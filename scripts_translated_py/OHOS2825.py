...
print('log "***Script name OHOS2825***"') 
...
eld_core.changeDriverStatus('ON', 'YM', 'false', ' ', ' ')
eld_core.changeDriverStatus('ON', 'YM', '123', 'false', ' ')
eld_core.changeDriverStatus('ON', 'YM', 'OHOS', 'false', ' ')
eld_core.changeDriverStatus('ON', 'YM', '123', 'false', ' ')
eld_core.changeDriverStatus('ON', 'YM', 'OHOS', 'false', ' ')